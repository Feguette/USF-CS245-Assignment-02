...
public class HybridSortTest {
	...
	protected double [] arr;                  // This is the array to be sorted.
	 ...
	 * @param arraySize
	 */
	public HybridSortTest(int arraySize) {
		populationStrategy = "random";
	 ...
	 */
	public HybridSortTest(int arraySize, String populationStrategy) {
	...
	public static void main(String[] args) {
		...
		HybridSortTest timing = new HybridSortTest();
		int [] sizes = {50000, 100000, 150000, 200000, 250000, 300000, 350000, 400000, 450000, 500000};
		//int [] sizes = {250000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000, 500000};
		//int [] sizes = {2,5, 10};
